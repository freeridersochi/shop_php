...
require_once 'src/include/product_functions.php';//link promo function';//link promo function
...
// Include temlate "layout.php" and data from $home_data
$include_result = include_template('./src/templates/layout.php', [
                                                'title' => 'Super Shop.Главная',
                                                'content' => $home_page
                                              ]);
